...
public class QrActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.qr_el).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String[] el = new String[]{"Error correction level L (7%)", "Error correction level M (15%)", "Error correction level Q (25%)", "Error correction level H (30%)"};
    ...
    public void onClick(View view) {
        ...
        if (!BluetoothUtil.isBlueToothPrinter) {
            starPOSPrintHelper.getInstance().printQr(mTextView1.getText().toString(), print_size, error_level);
